	<div class="clearfix blog-content <?php post_class(); ?>">
		...
		<div class="blog-image">
			...
			<div class="blog-overlay">
				...
				<div class="post-view">
					<a href="<?php esc_url(the_permalink()); ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
					<a href="<?php esc_url(the_post_thumbnail_url()); ?>"><i class="fa fa-search-plus" aria-hidden="true"></i></a>
				</div>
			</div>
		</div>	
